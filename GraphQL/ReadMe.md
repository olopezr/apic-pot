...
[Setup Common registry for API Manager](../Login-apic/ReadMe.md)
...
**Comment to Instructors and Students:**  An issue has been noted that the editor does not render and you are not able to enter account and shipping address detail. <br>
**Open a new tab** with the GraphiQL URL, i.e: <https://apim-demo-gw-gateway-cp4i-apic.apps.ventress.coc-ibm.com/ventressX-porg/sandbox/accounts/graphql> <br> Just replace **ventressX** with your assigned user and check if your **Client ID** is correctly set. To check just click on **"Credentials"** at the top of the screen.
