...
<span style="color: red">Lab prerequisite:</span> ["The Developer Portal Experience"](../Developer-Portal/ReadMe.md)
...
5\. The Configuration screen will show the default Authorize and Token paths. <br>
For *Supported grant types*, **select** `Resource owner - Password` **[✓]** and **deselect** `Access code` **[ ]**.<br>
For *Supported client types*, **select** `Confidential` **[✓]**.  Click **Next**.
